...
page.get_by_role("textbox", name="* 账号").fill("<ADMIN_USER>")
...
page.get_by_role("textbox", name="* 负责人手机号 :").fill("<TEST_PHONE>")
...
page.get_by_role("textbox", name="用户注册的手机 :").fill("<TEST_PHONE>")
page.get_by_role("button", name="查 询").click()
page.get_by_role("button", name="重 置").click()
...
page.get_by_role("menu").get_by_text("线索管理").click()
    ...
    page.get_by_role("textbox", name="车主手机 :").fill("<TEST_PHONE>")
    page.get_by_role("button", name="查 询").click()
    page.get_by_role("button", name="重 置").click()
